...
import {
  Card, CardActions, CardContent, CardMedia, Container, Grid, IconButton,
  Button, Typography, Box, TextareaAutosize
} from '@mui/material';
...
const Cart = () => {
  ...
  const renderTotal = useCallback(() => {
    const total = docs.reduce((n, { price, quantity }) => n + (price * quantity), 0);
    setTotal(total);
  }, [docs]);
